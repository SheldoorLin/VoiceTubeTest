...
@Database(entities = [SettingStatus::class], version = 2, exportSchema = false)
abstract class VoiceTubeDatabase : RoomDatabase() {

    /**
     * Connects the database to the DAO.
     */
    abstract val voiceTubeDatabaseDao: VoiceTubeDatabaseDao
    ...
    companion object {
         ...
         */
        @Volatile
        private var INSTANCE: VoiceTubeDatabase? = null
         ...
         */
        fun getInstance(context: Context): VoiceTubeDatabase {
